...
class _FeedbackScreenState extends State<FeedbackScreen> {
                  ...
                  children: [
                    Center(
                        child: Padding(
                          ...
                          child: Text(rating.toString(),style: TextStyle(color: Colors.black,fontFamily: AppConstant.fontBold,fontSize: 20),),
                          ...
                          builder: (context, projectSnap) {
                            ...
                            if (projectSnap.connectionState == ConnectionState.done) {
                              ...
                              if (projectSnap.data != null) {
                                result = projectSnap.data.data.feedback;
                                if (result != null) {
                                  print(result.length);
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Padding(
                      ...
                      child: Text(result.customerName,style: TextStyle(color: Colors.black,fontSize: 16,fontFamily: AppConstant.fontBold),),
                    ),
                    /* Padding(
                ...
                Padding(
                  padding: EdgeInsets.only(left: 16,top: 10),
                  child: Text(result.message,style: TextStyle(color: Colors.black,fontSize: 14,fontFamily: AppConstant.fontRegular),),
                ),
                Divider(
  ...
  Future<GetFeedback> getFeedback(BuildContext context) async {
    ...
    try {
      ...
      GetFeedback bean = await ApiProvider().getFeedback(from);
      print(bean.data);

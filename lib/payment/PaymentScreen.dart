          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 180,
                child:  Center(
                  child: Image.asset(Res.ic_payment_default,),
                )
              ),

              Padding(
                padding: EdgeInsets.only(left: 16,top: 16),
                child: Text("Total Earning",style: TextStyle(color: Colors.black,fontSize: 14,fontFamily: AppConstant.fontRegular),),
              ),
              ...
              Row(
                children: [
                  Expanded(
                    child: Padding(
                      padding: EdgeInsets.only(left: 16,top: 16),
                      child: Text(AppConstant.rupee+totalEarning,style: TextStyle(color: AppConstant.lightGreen,fontSize: 22,fontFamily: AppConstant.fontBold),),
                    ),
                  ),
...
/*                  payment();*/
        ...
        Row(
          children: [
            Expanded(
              child: Padding(
                padding: EdgeInsets.only(left: 16,top: 16),
                child: Text("Customer ID 1234",style: TextStyle(color: Colors.black,fontFamily: AppConstant.fontRegular),),
              ),
            ),

            Padding(
              padding: EdgeInsets.only(left: 16,top: 16,right: 16),
              child: Text(AppConstant.rupee+data.amount,style: TextStyle(color: Colors.black,fontFamily: AppConstant.fontBold),),
            )
          ],
        ),
        Padding(
          padding: EdgeInsets.only(left: 16,top: 16),
          child: Text(data.transactionDate,style: TextStyle(color: Colors.grey,fontFamily: AppConstant.fontBold),),
        ),
        Divider(
  ...
  Future<BeanPayment> payment() async {
    progressDialog.show();
    try {
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  Text(AppConstant.rupee+totalEarning, textAlign: TextAlign.center,
                    style: TextStyle(
